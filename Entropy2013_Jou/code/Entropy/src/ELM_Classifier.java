...
public class ELM_Classifier {
	...
	private Matrix test;
	public ELM_Classifier(int Columns,int Labels, Matrix train, Matrix test){
	...
	public void setTest(Matrix test){
		this.test = test;
	}
	
	public void ELM_Train(int NumofHiddenNeurons, String ActivationFun){
//		train.print(8, 5);
