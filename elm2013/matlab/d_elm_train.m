function [InputWeight, BiasofHiddenNeurons, OutputWeight,label] = d_elm_train(TrainingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
...
if Elm_Type~=REGRESSION
    save(cat(2,TrainingData_File,'_elm_model'), 'NumberofInputNeurons', 'NumberofOutputNeurons', 'InputWeight', 'BiasofHiddenNeurons', 'OutputWeight', 'ActivationFunction', 'label', 'Elm_Type');
else
    save(cat(2,TrainingData_File,'_elm_model'), 'InputWeight', 'BiasofHiddenNeurons', 'OutputWeight', 'ActivationFunction', 'Elm_Type');    
end