...
%Test1:[TrainingTime,TestingTime,TrainingAccuracy,TestingAccuracy]=elm('..\datasets\diabetes\train.data','..\datasets\diabetes\test.data',1,100,'sig')
%
%[TrainingTime,TestingTime,TrainingAccuracy,TestingAccuracy]=elm('sat_train','sat_test',1,200,'sig')
...
T=train_data(:,1)';%%Tȡ����train_data�ĵ�һ�У�Ȼ��ת��
P=train_data(:,2:size(train_data,2))';%%size(train_data,2)�������train_data������
clear train_data;                                   %   Release raw training data array

%%%%%%%%%%% Load testing dataset
test_data=load(TestingData_File);%%����TestingData_File,�õ�����test_data
TV.T=test_data(:,1)';
